        ...
        if (ret != SQL_ERROR || Sql_NumRows(SqlHandle) != 0)
        {
            ...
            while (Sql_NextRow(SqlHandle) == SQL_SUCCESS)
            {
                if (mCount == monster)
                {
                    ...
                    // The ONLY fished notorious monster. << This isn't strictly true!
            ...
            int32 skillMult = (skilldiff / 10);
		{
...

			{
               // Player is between the fish min and max skill level, so increase chance of skill up. //
                ...
                skillUpChance = (3 - (log(1 + charSkill / 100))) / 9;
                //skillUpAmount += 1;
                skillUpAmount += skillMult;
            }
            else if (((charSkill / 10) < fishMaxSkill))
			{
                ...
                skillUpChance = (3 - (log(1 + charSkill / 100))) / 10;
				//skillUpAmount += 2; //changing from 2 to 1
                skillUpAmount += skillMult;
            }
            }
			...
			{
                v2 = rand() % 3;//not bad at 2
                skillUpAmount += skillUpAmount + v2; // gives 0.1 or 0.2
                if (skillUpAmount > 9)
				{
                    skillUpAmount = 9;
                }
                ...
                if (fightStamina == 0)
                {
                    ...
                    else
                    {
                        ...
                        if (rodbreak == 1)
                        {
                            ...
                            breakpercent = (breakpercent + (skilldiff / 2));
                            if (breakpercent >= 85) //this was set at 25 which I feel is rather low
                            {
                        ...
                        if (((charSkill / 10 + ((charSkill / 10) * 0.5)) < fishMinSkill) && (special < 10) || Legend == 3)
                        {
