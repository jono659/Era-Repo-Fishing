...
// Era Custom Code Begin
				if(synthDiff > -11) //0-10 levels over recipe
				{
				    ...
				    hqtier = 2; //Tier 1 - 12%  //era custom
				else if (synthDiff > -51) //31-50 levels over recipe
				
					hqtier = 3; //Tier 2 - 35%
					
				else if (synthDiff > -81) //51-80 levels over recipe
				
					hqtier = 4; //Tier 3 - 60%
					
				else //81-99 levels over recipe
				
					hqtier = 5; //Tier 4 - 75% //era custom
			}
			else
			{
...
// Era Custom Code Begin
					switch(hqtier)
					{
						case 5:  chance = 0.750; break; //Tier4
						case 4:  chance = 0.600; break; //Tier3
						case 3:  chance = 0.350; break; //Tier2
						case 2:  chance = 0.120; break; //Tier1
						case 1:  chance = 0.035; break; //Tier0
