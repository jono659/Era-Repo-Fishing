...
namespace petutils
{
    ...
    ************************************************************************/
    ...
    void LoadJugStats(CPetEntity* PMob, Pet_t* petStats){
        ...
        PMob->setModifier(Mod::DEF, GetJugBase(PMob, petStats->defRank) * (1.25)); // Custom Era Content
        PMob->setModifier(Mod::EVA, GetJugBase(PMob, petStats->evaRank) * (1.25)); // Custom Era Content
        PMob->setModifier(Mod::ATT, GetJugBase(PMob, petStats->attRank) * (1.25)); // Custom Era Content
        PMob->setModifier(Mod::ACC, GetJugBase(PMob, petStats->accRank) * (1.25)); // Custom Era Content
