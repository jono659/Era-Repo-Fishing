...
SUBdsp.effects.POISON            = 10;  -- 1-01010      21
SUBdsp.effects.PARALYSIS         = 11;
SUBEFFECT_AMNESIA           = 11;  -- Verified uses same animation as para
SUBEFFECT_BLIND             = 12;  -- 1-00110      25
SUBdsp.effects.SILENCE           = 13;
SUBEFFECT_PETRIFY           = 14;
SUBEFFECT_PLAGUE            = 15;
SUBdsp.effects.STUN              = 16;
SUBEFFECT_CURSE             = 17;
...
dsp.effects.KO                       = 0
dsp.effects.WEAKNESS                 = 1
EFFECT_SLEEP_I                  = 2
dsp.effects.POISON                   = 3
dsp.effects.PARALYSIS                = 4
dsp.effects.BLINDNESS                = 5
dsp.effects.SILENCE                  = 6
dsp.effects.PETRIFICATION            = 7
dsp.effects.DISEASE                  = 8
dsp.effects.CURSE_I                  = 9
dsp.effects.STUN                     = 10
dsp.effects.BIND                     = 11
EFFECT_WEIGHT                   = 12
EFFECT_SLOW                     = 13
