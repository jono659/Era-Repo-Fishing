...
NORMAL_MOB_MAX_LEVEL_RANGE_MIN = 91; -- Lower Bound of Max Level Range for Normal Mobs (0 = Uncapped)
NORMAL_MOB_MAX_LEVEL_RANGE_MAX = 94; -- Upper Bound of Max Level Range for Normal Mobs (0 = Uncapped)
...
SHOP_PRICE      = 1.250; -- Multiplies prices in NPC shops.
GIL_RATE        = 4.900; -- Multiplies gil earned from quests.  Won't always display in game.
BAYLD_RATE      = 1.000; -- Multiples bayld earned from quests.
EXP_RATE        = 0.900; -- Multiplies exp earned from fov and quests.
TABS_RATE       = 1.050; -- Multiplies tabs earned from fov.
...
FrigiciteDuration = 80; -- When OldSChoolG2 is enabled, this is the time (in seconds) you have from killing Boreal NMs to click the "???" target.
...
KILLER_EFFECT = 11; -- Intimidation percentage from killer job traits.
...
TIMEZONE_OFFSET = -6.0; -- Offset from UTC used to determine when "JP Midnight" is for the server.  Default is JST (+9.0).
