...
function onMobFight(mob,killer)
	...
	elseif (mob:getMobMod(MOBMOD_DRAW_IN) == 2 and mob:getBattleTime() - changeTime > 120) then
		mob:setMobMod(MOBMOD_DRAW_IN, 1);
	end]]-- Cant get this to work setting as always alliance type for now.. MUST FIX Lau ~
