...
if (mobID == 16896157) then
    if ((mobHPP <= 80) and mob:getLocalVar("CanPop1") == 0) then
        local dragonadd = math.random(1,4)
--        print(dragonadd);
        if (dragonadd == 1 and mob:getLocalVar("16896158Pop") == 0) then
            SpawnMob(16896158):updateEnmity(target);
            mob:setLocalVar("CanPop1",1);
            mob:setLocalVar("16896158Pop",1);
        elseif (dragonadd == 2 and mob:getLocalVar("TiaPop") == 0) then
            SpawnMob(16896159):updateEnmity(target);
            mob:setLocalVar("CanPop1",1);
            mob:setLocalVar("TiaPop",1);
        elseif (dragonadd == 3 and mob:getLocalVar("16896160Pop") == 0) then
            SpawnMob(16896160):updateEnmity(target);
            mob:setLocalVar("CanPop1",1);
            mob:setLocalVar("16896160Pop",1);
        elseif (dragonadd == 4 and mob:getLocalVar("16896161Pop") == 0) then
            SpawnMob(16896161):updateEnmity(target);
            mob:setLocalVar("CanPop1",1);
            mob:setLocalVar("16896161Pop",1);
        end
    elseif ((mobHPP <= 60) and mob:getLocalVar("CanPop2") == 0) then
        local dragonadd = math.random(1,4)
--        print(dragonadd);
        if (dragonadd == 1 and mob:getLocalVar("16896158Pop") == 0) then
            SpawnMob(16896158):updateEnmity(target);
            mob:setLocalVar("CanPop2",1);
            mob:setLocalVar("16896158Pop",1);
        elseif (dragonadd == 2 and mob:getLocalVar("TiaPop") == 0) then
            SpawnMob(16896159):updateEnmity(target);
            mob:setLocalVar("CanPop2",1);
    ...
    elseif ((mobHPP <= 40) and mob:getLocalVar("CanPop3") == 0) then
        local dragonadd = math.random(1,4)
--        print(dragonadd);
        if (dragonadd == 1 and mob:getLocalVar("16896158Pop") == 0) then
            SpawnMob(16896158):updateEnmity(target);
            mob:setLocalVar("CanPop3",1);
            mob:setLocalVar("16896158Pop",1);
        elseif (dragonadd == 2 and mob:getLocalVar("TiaPop") == 0) then
            SpawnMob(16896159):updateEnmity(target);
            mob:setLocalVar("CanPop3",1);
    ...
    elseif ((mobHPP <= 20) and mob:getLocalVar("CanPop4") == 0) then
        local dragonadd = math.random(1,4)
--        print(dragonadd);
        if (dragonadd == 1 and mob:getLocalVar("16896158Pop") == 0) then
            SpawnMob(16896158):updateEnmity(target);
            mob:setLocalVar("CanPop4",1);
            mob:setLocalVar("16896158Pop",1);
        elseif (dragonadd == 2 and mob:getLocalVar("TiaPop") == 0) then
            SpawnMob(16896159):updateEnmity(target);
            mob:setLocalVar("CanPop4",1);
